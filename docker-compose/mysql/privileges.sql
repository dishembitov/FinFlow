CREATE USER 'dishembitov_development'@'%' IDENTIFIED BY 'oPItyPticIAt';
GRANT CREATE, ALTER, DROP, INSERT, UPDATE, DELETE, SELECT, REFERENCES on *.* TO 'dishembitov_development'@'%';
FLUSH PRIVILEGES;
